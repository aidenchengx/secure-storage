...
def st_upload(parser, args, output_manager, return_parser=False):
    ...
    parser.add_argument(
	'-E',dest='encrypt_level',help='Upload the objects using servers encryption',default='none',
        ...
        try:
            ...
            for f in files:
                ...
                if isfile(f):
                    ...
                    output_manager.error("Local file 77 '%s' not found" % f)
